...
public interface ICloudSqlPostgresqlConnector extends JpaRepository<KokoroFlatEntity, UUID> {
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_battle_master_op_pattern from kokoro_combination_battle_master where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_battle_master_os_pattern from kokoro_combination_battle_master where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_battle_master_opos_pattern from kokoro_combination_battle_master where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_battle_master_opdx_pattern from kokoro_combination_battle_master where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_battle_master_ds_pattern from kokoro_combination_battle_master where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_sage_op_pattern from kokoro_combination_sage where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_sage_os_pattern from kokoro_combination_sage where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_sage_opos_pattern from kokoro_combination_sage where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_sage_opdx_pattern from kokoro_combination_sage where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_sage_ds_pattern from kokoro_combination_sage where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_ranger_op_pattern from kokoro_combination_ranger where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_ranger_os_pattern from kokoro_combination_ranger where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_ranger_opos_pattern from kokoro_combination_ranger where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_ranger_opdx_pattern from kokoro_combination_ranger where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_ranger_ds_pattern from kokoro_combination_ranger where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_armamentalist_op_pattern from kokoro_combination_armamentalist where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_armamentalist_os_pattern from kokoro_combination_armamentalis where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_armamentalist_opos_pattern from kokoro_combination_armamentalis where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_armamentalist_ds_pattern from kokoro_combination_armamentalis where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_paladin_os_pattern from kokoro_combination_paladin where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_paladin_opos_pattern from kokoro_combination_paladin where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_paladin_opdx_pattern from kokoro_combination_paladin where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_paladin_ds_pattern from kokoro_combination_paladin where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_superstar_os_pattern from kokoro_combination_superstar where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_superstar_opos_pattern from kokoro_combination_superstar where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_superstar_opdx_pattern from kokoro_combination_superstar where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_superstar_ds_pattern from kokoro_combination_superstar where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_pirate_op_pattern from kokoro_combination_pirate where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_pirate_os_pattern from kokoro_combination_pirate where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_pirate_opdx_pattern from kokoro_combination_pirate where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
  ...
  @Query(value = "select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_pirate_ds_pattern from kokoro_combination_pirate where total_cost < ?1 and k0id not in ?2 and k1id not in ?2 and k2id not in ?2 and k3id not in ?2 and concat(k0id, '_', k0rank) not in ?3 and concat(k1id, '_', k1rank) not in ?3 and concat(k2id, '_', k2rank) not in ?3 and concat(k3id, '_', k3rank) not in ?3", nativeQuery = true)
