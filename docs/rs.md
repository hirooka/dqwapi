...
select k0id, k0rank, k1id, k1rank, k2id, k2rank, k3id, k3rank, max_battle_master_op_pattern 
...
and concat(k0id, concat('_', k0rank)) not in ('404_1', '100b') and concat(k1id, concat('_', k1rank)) not in ('100a', '100b') 
